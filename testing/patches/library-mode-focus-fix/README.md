...
This setting-free patch corrects NuvioTV 0.8.5-beta's native Library focus path. When the user moves down from Saved or Cloud into the first filter and then moves back up, focus returns to the selected mode instead of jumping to another mode.
