...
The behavior is derived from NuvioMedia/NuvioTV PR #2384, rebased there onto the 0.8.x development line. The patch targets the released `0.8.5-beta` APKs only.
