...
5. On `Television_4K`, install the universal-derived output and execute every acceptance item in `patch.json`, including D-pad navigation and Media3 playback.
